...
<#if compulsoryFields?seq_contains("telephone") >	
	...
	$.post('/weblet/shopping/account_action/saveAddressBook',$.param(data) ,function(data, status,jqXHR) {
		...
		<#set addressBook = addressBookJSON.addressBook>
			...
			<div class="panel" id="cur_address_book">
				...
				<div class="clearfix">
					...
					<span class="right"><a href="/tpl/shipping" class="button small">Use this address</a></span>					
				</div>
			</div>
	<#else>
		<script>
